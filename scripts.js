const questions = {
    elektrotechnik: [
    { question: "Wie lautet die Einheit des elektrischen Stromes <em>I</em> ?", answers: ["Ohm", "Ampere", "Volt", "Watt"], correct: 1 },
    ...
    { question: "Wie lautet die Einheit des elektrischen Widerstandes <em>R</em> ?", answers: ["Watt", "Ampere", "Volt", "Ohm"], correct: 3 },
    { question: "In welcher Einheit wird die elektrische Leistung <em>P</em> angegeben ?", answers: ["VA", "Ws", "W", "var"], correct: 2 },
    { question: "Welche Formeln geben das Ohmsche Gesetz wieder ?", answers: ["<em>R</em> = <em>I</em> / <em>U</em>", "<em>U</em> = <em>R</em> / <em>I</em>", "<em>U</em> = <em>R</em> * <em>I</em>", "<em>I</em> = <em>U</em> / <em>R</em>"], correct: [2, 3] },
    { question: "Was passiert, wenn mehrere Widerstände in Reihe geschaltet werden ?", answers: ["Der Gesamtwiderstand sinkt", "Bei konstanter Spannung <em>U</em> sinkt der Strom <em>I</em>", "Der Gesamtwiderstand ändert sich nicht", "Bei konstanter Spannung <em>U</em> steigt der Strom <em>I</em>"], correct: 1 },
    { question: "Welche Größe ist die gemeinsame Größe in einer Parallelschaltung ?", answers: ["Spannung <em>U</em>", "Strom <em>I</em>", "Arbeit <em>W</em>", "Leistung <em>P</em>"], correct: 0 },
    { question: "Was passiert, wenn mehrere Widerstände parallel geschaltet werden ?", answers: ["Der Gesamtwiderstand <em>R</em>steigt", "Bei konstanter Spannung <em>U</em> sinkt der Strom <em>I</em>", "Der Gesamtwiderstand <em>R</em>ändert sich nicht", "Bei konstanter Spannung <em>U</em> steigt der Strom <em>I</em>"], correct: 3 },
    { question: "Welche Größe ist die gemeinsame Größe in einer Reihenschaltung ?", answers: ["Arbeit <em>W</em>", "Spannung <em>U</em>", "Leistung <em>P</em>", "Strom <em>I</em>"], correct: 3 },
    { question: "Welcher Formelbuchstabe wird für die Kapazität <em>C</em> eingesetzt ?", answers: ["<em>H</em>", "<em>L</em>", "<em>Q</em>", "<em>C</em>"], correct: 3 },
    { question: "In welcher Einheit wird die Kapazität angegeben ?", answers: ["<em>H</em>", "<em>Vs</em>", "<em>F</em>", "<em>As</em>"], correct: 2 },
    ...
    { question: "Wie nennt man den Gesamtwiderstand <em>R</em> im Wechselstromkreis ?", answers: ["Scheinwiderstand", "Blindwiderstand", "Wirkwiderstand", "Hellwiderstand"], correct: 0 },
    { question: "Welcher Formelbustabe gilt für den Scheinwiderstand ?", answers: ["<em>P</em>", "<em>R</em>", "<em>S</em>", "<em>Q</em>"], correct: 2 },
    ...
    { question: "Vier Widerstände (18 Ohm, 35 Ohm, 22 Ohm und 25 Ohm liegen an U = 200 V. Wie groß sind <em>R</em> und <em>I</em> ?", answers: ["200 Ohm und 2 A", "100 Ohm und 1 A", "100 Ohm und 2 A", "1000 Ohm und 2 A"], correct: 2 },
    { question: "Vier Widerstände (24 kOhm, 24 kOhm, 12 kOhm und 6 kOhm liegen an <em>U</em> = 120 V. Wie groß sind <em>R</em> und <em>I</em>?", answers: ["3 kOhm und 0,04 mA", "3 Ohm und 400 mA", "3 kOhm und 40 mA", "3 Ohm und 40 mA"], correct: 2 },
    { question: "Welche Aussage ist richtig ?", answers: ["In einer Parallelschaltung steigt der Gesamtwiderstand mit steigender Anzahl von Teilwiderständen", "In einer Parallelschaltung sinkt der Gesamtwiderstand mit kleiner werdenden Anzahl von Teilwiderständen", "In einer Parallelschaltung sinkt der Gesamtwiderstand mit steigender Anzahl von Teilwiderständen", "In einer Parallelschaltung steigt der Gesamtwiderstand mit kleiner werdenden Anzahl von Teilwiderständen"], correct: 2 },
...
function displayQuestion() {
    ...
    questionData.answers.forEach((answer, answerIndex) => {
        ...
        answerButton.innerHTML = answer; // Verwendet innerHTML, um HTML in den Antworten zu unterstützen
